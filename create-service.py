...
ssl = parsed_args.ssl if parsed_args.ssl is not False else parsed_args.no_ssl if parsed_args.no_ssl is not True else None 
logging.debug(f'Parsed Arguments: domain={domain}, port={port}, ssl={parsed_args.ssl}, no_ssl={parsed_args.no_ssl}, ssl={ssl}')
